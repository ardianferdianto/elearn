	...
	<div class="tryout-soal-wrapper clearfix">
		<h2>halaman Soal</h2>
			...
			<ul class="list-button-kuis">
				<li><a class="button-pembelajaran" id="download-btn" href="<?php echo $this->webroot; ?>quizzs/view_pdf/<?php echo $quizz['Quizz']['id']; ?>"></a></li>
				...
				<li><a class="button-pembelajaran" id="back-btn" href="<?php echo $this->webroot; ?>quizzs"></a></li>
			...
			<div class="tryout-content clearfix">
				...
				if($banyakSoal == 0) :
					...
					<div class="soal-entry clearfix">
							...
							<?php
							echo '<h6>'.$no.'.&nbsp;&nbsp;&nbsp;&nbsp;'.$n['question'].'</h6><br/><br/>';
							...
							if ($n['tipe'] == 1){
								...
								echo "a. &nbsp;".$n['answer_a'];?><!--<?php if($n['answer_true']==1){echo " <span class='input-notification success png_bg'></span>";}?>--><br/><br/><br/>
								<?php 

								echo "b. &nbsp;".$n['answer_b'];?><!--<?php if($n['answer_true']==2){echo " <span class='input-notification success png_bg'></span>";}?>--><br/><br/><br/>
								<?php 

								echo "c. &nbsp;".$n['answer_c'];?><!--<?php if($n['answer_true']==3){echo " <span class='input-notification success png_bg'></span>";}?>--><br/><br/><br/>
								<?php 

								echo "d. &nbsp;".$n['answer_d'];?><!--<?php if($n['answer_true']==4){echo " <span class='input-notification success png_bg'></span>";}?>--><br/><br/><br/>
							<?php	
							}else if($n['tipe'] == 2){
