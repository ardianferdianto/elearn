<div class="quizzs form">
	<h2><?php __('Form Penambahan Kuis Online');?></h2>
	<p>
	Selamat datang di form penambahan kuis online. silahkan isi form yang tersedia
	</p>
	<div class="clear"></div> 
	<div class="content-box"><!-- Start Content Box -->
		...
		<div class="content-box-header">
			...
			<h3>From Penambahan Kuis Online</h3>
