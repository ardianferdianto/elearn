...
<?php if($groupAuth != 3){?>
<p>
<?php echo $html->link(__('Merasa tidak benar ?, atau ingin menambahkan arti dati kata ini ? edit kata ini', true), array('action' => 'form_edit',$word['Englishse']['id'])); ?>
</p>
<?php } ?>
</div>
</div>
