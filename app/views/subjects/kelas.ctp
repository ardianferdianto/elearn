	...
	<div id="pembelajaran-isi">
		...
		<div class="itemisotope tooltip" title="<?php echo $subject['Subject']['name'];?>">
			<div class="box boxcd" id="#">
				<a  href="<?php echo $this->webroot;?>subjects/view/?filename=<?php echo $mylearn;?>/flash/<?php echo $subject ['Subject']['folder_name']; ?>/<?php echo $subject ['Subject']['file_name']; ?>&filefolder=<?php echo $mylearn?>/flash/<?php echo $subject ['Subject']['folder_name']; ?>" class="ebookpopup cdpembelajaran">
