...
<div class="quizzs view">
	...
	<div class="actions">
		...
		<tr>
			...
			<th><strong>Jawaban Uraian</strong></th>
		...
		?>
			...
			<tr<?php echo $class; ?>>
				...
				<td>
					<?php echo $html->link('Lihat jawaban uraian', array('controller'=>'uraian_answers','action' => 'view/'.$quizzPoint['User']['id'].'/'.$quizzPoint['Quizz']['id']),array('class'=>'button')); ?>
				</td>
				<td>
	 ...
	 <?php echo '<br/><br/>'.$html->link('Kembali', array('controller'=>'users','action' => 'siswa',$pointFirst['User']['kelas']),array('class'=>'button','style'=>'display:inline-block;margin-left:8px;float:left;'));?>
	 <?php echo $html->link('Print data ini', array('action' => 'print_history/'.$siswaId),array('class'=>'button','style'=>'display:inline-block;margin-left:8px;float:left;'));?>
	<?php echo $html->link('Export worksheet', array('action' => 'export_xls/'.$siswaId),array('class'=>'button','style'=>'display:inline-block;margin-left:8px;float:left;'));?>
</div><!-- End content box -->
