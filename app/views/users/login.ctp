<img src="<?php echo $this->webroot;?>/resources/images/user-ico.png" style="margin-bottom:8px; width:50px;">
...
<!--<a href="<?php echo $this->webroot;?>monitors/setup"><img src="<?php echo $this->webroot;?>/resources/images/monitorsetup.png"/></a>-->
<?php echo $form->end();
?>
<div class="clear"></div>
</p>