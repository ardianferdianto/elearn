...
<div class="install">
	...
	<script type="text/javascript">
	//<![CDATA[
	Event.observe('run_install', 'click', function(event) { new Ajax.Updater('status_sims','/anjungan-sains/install/runDbSims/run:1', {asynchronous:true, evalScripts:true, requestHeaders:['X-Update', 'status_sims']}) }, false);
	//]]>
	</script>
	<div id="status">
		<div class="menu" id="loading_list">
			<ul>
				<li>
					...
					<p>
					<?php echo $html->image('loading-install.gif');?><span>Harap tunggu sistem sedang menginstall MyQuizz</span>
					</p>
					</div>
				</li>
