...
//include ('../../../../../config.php');
//$config2= new Config();
$baseUrl = '/'.$appName.'/files/ckuploads/';//as we want to have all of our files under webrrot/files/ckuploads folder
$baseDir = $_SERVER['DOCUMENT_ROOT'].'/'.$appName.'/app/webroot/files/ckuploads/';
